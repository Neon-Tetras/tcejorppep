            ...
            <div class="row"  >
                ...
                <div class="col-md-4 col-centered" style="border: 1px   inset #222 ;" >
                    ...
                    <ul class="nav nav-tabs  nav-justified ">
                        ...
                        <li id="login_tab" class="active"><a data-toggle="pill" href="#login">Login</a></li>
                        <li id="register_tab"><a data-toggle="pill" href="#register">Register</a></li>
                            ...
                            <form name="user_reg_form" id="user_register_form" action="register" method="post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <p></p>
                                        <span style="font-size: 14px; color:red;"><?php echo form_error("username"); ?></span>
                                ...
                                <div style="position: relative; margin-bottom: 20px;">
                                    ...
                                    <input type="checkbox" name="terms_of_service"  id="terms_of_use" style="float:left;" onchange="doChange()" /> 
                                    <label for="terms_of_use" style="float:left;">I have read and agree with the <a href='#'>Terms of use</a></label>
                                </div>
                                <p>&nbsp;</p>
                                <button style="text-align:right; visibility: hidden; "   value="submit"
